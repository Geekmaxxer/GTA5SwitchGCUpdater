...
namespace GTA5SwitchGCUpdater
{
    ...
    internal static class UpdateChecker
    {
        ...
        private const string Repo = "GTA5SwitchGCUpdater";
        ...
        public static async Task<UpdateCheckResult?> CheckAsync()
        {
            try
            {
                ...
                client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("GTAGameconfigUpdater", AppVersion.Current));
